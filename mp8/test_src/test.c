...
int main(){
	...
	if( move_s(game_cpy1) == _move_s(game_cpy2))
		printf("test 7: pass - move_s returns the correct value\n");
	else
		printf("test 7: fail - move_s returns the incorrect value\n");
	...
	for( i = 0; i < 12; i ++){
		if (*ptr1 != *ptr2){
			printf("test 8: fail - move_s does not move tiles correctly\n");
			printf("Your output:");
			print_game(game_cpy1);
			printf("Correct output:");
			print_game(game_cpy2);
	...
	printf("test 8: pass - move_s moves the tiles around correctly\n");
	...
	for( i = 0; i < 12; i ++){
		if (*ptr1 != *ptr2){
			printf("test 10: fail - move_a does not move tiles correctly\n");
			printf("Your output:");
			print_game(game_cpy1);
			printf("Correct output:");
			print_game(game_cpy2);
	...
	printf("test 10: pass - move_a moves the tiles around correctly\n");
