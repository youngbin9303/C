...
a_C = a_A + a_B;
save_mp10mat(a_A,'input_mats/a_A.txt');
save_mp10mat(a_B,'input_mats/a_B.txt');
save_mp10mat(a_C,'output_mats/gold/a_C.txt');
...
sa_C = sa_A + sa_B;
save_mp10mat(sa_A,'input_mats/sa_A.txt');
save_mp10mat(sa_B,'input_mats/sa_B.txt');
save_mp10mat(sa_C,'output_mats/gold/sa_C.txt');
...
save_mp10mat(m_A,'input_mats/m_A.txt');
save_mp10mat(m_B,'input_mats/m_B.txt');
save_mp10mat(m_C,'output_mats/gold/m_C.txt');
...
save_mp10mat(sm_A,'input_mats/sm_A.txt');
save_mp10mat(sm_B,'input_mats/sm_B.txt');
save_mp10mat(sm_C,'output_mats/gold/sm_C.txt');
